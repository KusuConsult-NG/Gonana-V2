...
import '../api/request/card_request_body.dart';
import '../api/request/validate_request_body.dart';
...
class CardTransactionManager extends BaseTransactionManager {
  ...
  Future<CheckoutResponse> _validateChargeOnServer() {
    final Map<String, String?> params = validateRequestBody.paramsMap();
    final Future<TransactionApiResponse> future = service.validateCharge(params);
