...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( _Started value)?  started,TResult Function( _MessagesUpdated value)?  messagesUpdated,TResult Function( _SendMessage value)?  sendMessage,required TResult orElse(),}){
final _that = this;
switch (_that) {
case _Started() when started != null:
return started(_that);case _MessagesUpdated() when messagesUpdated != null:
return messagesUpdated(_that);case _SendMessage() when sendMessage != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( _Started value)  started,required TResult Function( _MessagesUpdated value)  messagesUpdated,required TResult Function( _SendMessage value)  sendMessage,}){
final _that = this;
switch (_that) {
case _Started():
return started(_that);case _MessagesUpdated():
return messagesUpdated(_that);case _SendMessage():
return sendMessage(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _Started value)?  started,TResult? Function( _MessagesUpdated value)?  messagesUpdated,TResult? Function( _SendMessage value)?  sendMessage,}){
final _that = this;
switch (_that) {
case _Started() when started != null:
return started(_that);case _MessagesUpdated() when messagesUpdated != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( String chatId)?  started,TResult Function( List<MessageEntity> messages)?  messagesUpdated,TResult Function( String text)?  sendMessage,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Started() when started != null:
return started(_that.chatId);case _MessagesUpdated() when messagesUpdated != null:
return messagesUpdated(_that.messages);case _SendMessage() when sendMessage != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( String chatId)  started,required TResult Function( List<MessageEntity> messages)  messagesUpdated,required TResult Function( String text)  sendMessage,}) {final _that = this;
switch (_that) {
case _Started():
return started(_that.chatId);case _MessagesUpdated():
return messagesUpdated(_that.messages);case _SendMessage():
return sendMessage(_that.text);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( String chatId)?  started,TResult? Function( List<MessageEntity> messages)?  messagesUpdated,TResult? Function( String text)?  sendMessage,}) {final _that = this;
switch (_that) {
case _Started() when started != null:
return started(_that.chatId);case _MessagesUpdated() when messagesUpdated != null:
return messagesUpdated(_that.messages);case _SendMessage() when sendMessage != null:
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Started&&(identical(other.chatId, chatId) || other.chatId == chatId));
}
...
class _MessagesUpdated implements ChatDetailEvent {
  const _MessagesUpdated(final  List<MessageEntity> messages): _messages = messages;
...
@override
String toString() {
  return 'ChatDetailEvent.messagesUpdated(messages: $messages)';
}
...
/// @nodoc
abstract mixin class _$MessagesUpdatedCopyWith<$Res> implements $ChatDetailEventCopyWith<$Res> {
