...
class _LoadWalletData implements WalletEvent {
  const _LoadWalletData();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _LoadWalletData);
}
...
@override
String toString() {
  return 'WalletEvent.loadWalletData()';
}
